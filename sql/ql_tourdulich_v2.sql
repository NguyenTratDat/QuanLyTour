...
----- Dump completed on 2024-11-20 22:00:00

ALTER TABLE `ql_tourdulich`.`tours` ADD COLUMN `IS_ACTIVE` TINYINT(1) DEFAULT 1 NULL AFTER `IMAGE`; 

ALTER TABLE `ql_tourdulich`.`tour_log` ADD COLUMN `TOTAL_PEOPLE` INT(11) NULL AFTER `STATUS`; 
ALTER TABLE `ql_tourdulich`.`tour_log` CHANGE `TOTAL_PEOPLE` `TOTAL_PEOPLE` INT(11) DEFAULT 0 NULL; 
ALTER TABLE `ql_tourdulich`.`tour_log` ADD COLUMN `CHILDS_AMOUNT` INT(11) DEFAULT 0 NULL AFTER `TOTAL_PEOPLE`, ADD COLUMN `ADULTS_AMOUNT` INT(11) DEFAULT 0 NULL AFTER `CHILDS_AMOUNT`, ADD COLUMN `TOTAL` FLOAT(11) DEFAULT 0 NULL AFTER `ADULTS_AMOUNT`; 
ALTER TABLE `ql_tourdulich`.`tour_log` ADD COLUMN `CODE_PAY` VARCHAR(255) NULL AFTER `TOTAL`; 

----- Dump completed on 2024-11-20 22:00:00

ALTER TABLE `ql_tourdulich`.`tour_details` 
ADD COLUMN `DETAIL_TEXT` LONGTEXT NULL AFTER `PDF`;
